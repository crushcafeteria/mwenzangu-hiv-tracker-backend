...
{{--            <div class="container">--}}
{{--                <h1>--}}
{{--                    <img src="https://placeimg.com/5000/1000/nature" alt="">--}}
{{--                <p style="text-align: center">{{ $content->topic }}</p>--}}
{{--                </h1>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--    <a href="{{('/content')}}" class="btn-card" >Back</a>--}}
{{--    <div class="col-md-10">--}}
...
<section class="post-content-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 post-title-block">
